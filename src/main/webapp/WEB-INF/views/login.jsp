						...
						<div
							...
							<div class="cell-xs-10 cell-sm-8 cell-md-5">
								<div
									...
									<div>
										<div class="offset-top-30 text-darker big text-bold">Ingresa
											con tu cuenta</div>
										<p class="text-extra-small text-dark offset-top-10">Ingresa
											tus credenciales abajo</p>
									</div>
									<!-- RD Mailform-->
									<form:form data-form-output="form-output-global"
										data-form-type="contact" method="post"
										class="text-left offset-top-50" action="/studentsmedia/">
										<div class="form-group">
											<div class="input-group input-group-sm">
												...
												<form:input path="username" id="login-your-login"
													placeholder="Usuario" type="text" name="login"
										...
										<div class="form-group offset-top-30">
											<div class="input-group input-group-sm">
												...
												<form:input path="password" id="login-your-password"
													placeholder="Contraseña" type="password" name="password"
													data-constraints="@Required" class="form-control" />
											</div>
										</div>
										<button type="submit" value="Login"
											class="btn btn-anis-effect  btn-sm btn-icon btn-block btn-primary offset-top-30">
											Iniciar Sesión <span
									...
									<div
										...
										<div class="offset-top-0">
											No tienes una cuenta? <a
												...
												class="text-picton-blue">Regístrate Aquí</a>.
										</div>
									</div>
								</div>
							</div>
